...
<?= $this->section('page_content'); ?>
    <div class="main-wrapper main-wrapper-1">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block">Hi, <?= view_cell('\App\Widget\ClientTemplate::getEmployeeName')?></div></a>
            <div class="dropdown-menu dropdown-menu-right">
              <div class="dropdown-title">Logged in 5 min ago</div>
              <a href="<?= base_url() ?>client/profile" class="dropdown-item has-icon">
                <i class="far fa-user"></i> Profile
              </a>
              <div class="dropdown-divider"></div>
              <a href="<?= base_url() ?>client/logout" class="dropdown-item has-icon text-danger">
      ...
      <!-- Main Content -->
      <?= $this->renderSection('page_content_body'); ?>
    </div>
<?= $this->endSection(); ?>