...
<?= $this->section('page_content_body') ?>
    <div class="main-content">
        <section class="section">
            <?= view_cell('\App\Widget\ClientTemplate::pageHeader', array('title' => 'Kategori', 'breadcrum' => array('Dashboard' => base_url(), 'Kategori' => '#')))?>
            <div class="section-body">
                <?= view_cell('\App\Widget\ClientTemplate::pageDesc', array('title' => 'Kategori', 'desc' => 'Halaman ini untuk mengelola nama - nama Kategori yang digunakan'))?>
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                    <table class="table table-striped" id="dataTable" width="100%" cellspacing="0" data-url="<?= base_url('client/api/category/index'); ?>" data-form="<?= base_url('client/setup/category/form/new'); ?>">
            ...
            columns : [
                ...
                { 
                    ...
                    "render": function(data){
                        return '<a href="category/form/' + data + '" class="btn btn-sm btn-info"><span class="fa fa-edit"></span></a>';;
                    }
                },
                {
                    "data": "category_id",
                    ...
                    "orderable":false,
                    "render": function(data){
                        return '<a href="category/delete/' + data + '" class="btn btn-sm btn-info" click="onDelete(' + data + ')"><span class="fa fa-trash"></span></a>';
                    }
                }
            ],
            processing  : true,
